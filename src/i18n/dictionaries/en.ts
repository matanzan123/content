...
export const en = {
  ...
  onboarding: {
    ...
    userNotFound: "No account with that email. Try signing up.",
  ...
  dashboard: {
    metaTitle: "Dashboard — ClipRewards",
    eyebrowCreator: "Creator account",
    eyebrowBrand: "Brand account",
    title: "Your ClipRewards account",
    subtitle:
      "You are approved. Connect the accounts ClipRewards needs to pay you for the clips you post.",
    verification: {
      title: "Identity verification",
      subtitle: "Required to receive payouts from ClipRewards.",
      statusVerified: "Verified",
      statusPending: "Pending",
      statusActionRequired: "Action needed",
      statusRestricted: "Restricted",
      statusUnknown: "Checking",
      checking: "Checking verification status…",
      notProvisioned: "Complete the account setup steps above before verifying your identity.",
      verifiedBody: "Your identity is verified. You are eligible to receive payouts.",
      pendingBody: "Your verification is being reviewed by Whop. This usually takes a short time.",
      unknownBody: "We could not read your verification status right now.",
      actionRequiredBody: "Whop requires the following before you can receive payouts:",
      restrictedBody: "Your account is restricted. Complete the required actions to restore access:",
      actionLabel: {
        verify_identity: "Verify your identity",
        verify_business: "Verify your business details",
        provide_external_account: "Add a payout bank account",
        accept_tos: "Accept Whop's terms of service",
      } as Record<string, string>,
      actionFallback: "Complete required action",
      startVerification: "Complete verification at Whop",
      startVerificationBusy: "Opening Whop…",
      returnNotice: "Return here after completing verification at Whop.",
      errors: {
        status: "We could not check your verification status. Please refresh.",
        start: "We could not open the verification flow. Please try again.",
        network: "Could not reach ClipRewards. Check your connection and try again.",
    ...
    payout: {
      ...
      subtitle: "Whether your Whop account can receive payments from ClipRewards.",
      statusReady: "Ready",
      statusPending: "Pending",
      statusRestricted: "Restricted",
      statusNotReady: "Not ready",
      statusUnknown: "Checking",
      checking: "Checking payout status…",
      notProvisioned: "Complete the account setup steps above before checking payout status.",
      readyBody: "Your account is set up to receive payouts. You are good to go.",
      pendingBody: "Your payout setup is under review by Whop. This usually resolves in a short time.",
      restrictedBody: "Your account has restrictions that must be resolved before payouts can be sent.",
      notReadyBody: "Your Whop account cannot yet receive payouts. This is separate from identity verification.",
      notReadyHint: "Complete the identity verification step above, then return to Whop to add a payout bank account.",
      unknownBody: "We could not determine your payout status right now. Please refresh.",
      manageButton: "Set up payout account",
      manageButtonBusy: "Opening Whop…",
      returnNotice: "Return here after setting up your payout account at Whop.",
      errors: {
        status: "We could not check your payout status. Please refresh.",
        network: "Could not reach ClipRewards. Check your connection and try again.",
        platforms_access_required: "Payout status is not available right now.",
        account_not_found: "Your Whop account was not found.",
        account_not_provisioned: "Your Whop account has not been set up yet.",
        provider_error: "Whop returned an error. Please try again shortly.",
    ...
    withdraw: {
      ...
      subtitle: "Transfer your available balance to your Whop account.",
      amountLabel: "Amount to withdraw (USD)",
      amountPlaceholder: "0.00",
      available: "Available",
      submitButton: "Request withdrawal",
      submitBusy: "Requesting…",
      cancelButton: "Cancel withdrawal",
      cancelBusy: "Canceling…",
      statusRequested: "Pending review",
      statusEligible: "Ready to process",
      statusProcessing: "Processing",
      statusProviderPending: "With Whop",
      statusPaid: "Paid",
      statusFailed: "Failed",
      statusCanceled: "Canceled",
      statusReversed: "Reversed",
      activeNotice: "You have a withdrawal in progress.",
      nothingAvailable: "No funds available to withdraw.",
      errors: {
        load: "Could not load withdrawal status.",
        amount_zero: "Amount must be greater than zero.",
        amount_exceeds_balance: "Amount exceeds your available balance.",
        rate_limited: "Too many requests. Please try again later.",
        insufficient_available: "No funds available to withdraw.",
        withdrawal_already_pending: "You already have a withdrawal in progress.",
        concurrent_reservation: "Another withdrawal was being processed. Please try again.",
        db_unavailable: "Service temporarily unavailable. Please try again.",
        platform_unavailable: "Payout service unavailable. Please try again.",
      } as Record<string, string>,
    },
    earnings: {
      title: "Your earnings",
      subtitle: "Balance across all payout states.",
      loading: "Loading earnings…",
      errorLoad: "Could not load earnings. Please refresh.",
      earned: "Total earned",
      pending: "Pending (hold period)",
      available: "Available",
      transferred: "Transferred to Whop",
      reversed: "Reversed",
      zeroState: "No earnings yet. Join a campaign to start earning.",
    },
    whop: {
      title: "Whop connection",
      subtitle: "Links your Whop account to ClipRewards.",
      statusConnected: "Connected",
      statusDisconnected: "Not connected",
      statusUnknown: "Checking",
      checking: "Checking your connection…",
      disconnectedBody:
        "Connect your Whop account so ClipRewards can verify your identity there and pay out against it. You will be sent to Whop to approve the connection, then brought straight back here.",
      connect: "Connect Whop",
      connecting: "Opening Whop…",
      accountLabel: "Whop account",
      accountUnknown: "Linked",
      connectedAtLabel: "Connected on",
      scopesLabel: "Permissions granted",
      disconnect: "Disconnect Whop",
      disconnecting: "Disconnecting…",
      confirmTitle: "Disconnect this Whop account?",
      confirmBody:
        "ClipRewards will stop using this Whop account. You can connect it again at any time, and signing out of ClipRewards does not disconnect it.",
      confirmDisconnect: "Yes, disconnect",
      adminNotice:
        "Administrator accounts do not link a Whop account of their own. Sign in as a creator or brand account to manage a Whop connection.",
      notices: {
        connected: "Your Whop account is connected.",
        cancelled: "The connection was cancelled at Whop. Nothing changed.",
        expired: "That connection link expired. Please try again.",
        mismatch: "That connection could not be verified in this browser. Please try again.",
        already_linked: "That Whop account is already connected to another ClipRewards user.",
        unavailable: "Whop connection is unavailable right now. Please try again shortly.",
      ...
      errors: {
        status: "We could not check your connection. Please refresh.",
        connect: "We could not start the connection. Please try again.",
        disconnect: "We could not disconnect. Please try again.",
        network: "Could not reach ClipRewards. Check your connection and try again.",
        signedOut: "Please sign in again to manage your Whop connection.",
        unavailable: "Whop connection is unavailable right now. Please try again shortly.",
        not_approved: "Your account is not approved for Whop connection yet.",
        not_connected: "There is no Whop account connected.",
        unauthenticated: "Please sign in again to manage your Whop connection.",
        unconfigured: "Whop connection is not configured on this server.",
      },
    },
  },
  ...
  approval: {
    ...
    booked: {
      ...
      linkDelayed: "Your interview is confirmed. We will send your Google Meet link before the call.",
  ...
  admin: {
    ...
    applicants: {
      awaitingTitle: "Awaiting decision",
      awaitingHint: "Applicants who have booked their interview and are waiting on a decision.",
      noneAwaiting: "Nobody is waiting for a decision right now.",
      allTitle: "All applicants",
      allHint: "Everyone else, including decided accounts. A decision can be revisited.",
      statAwaiting: "Awaiting",
      statTotal: "Total users",
      statCreators: "Creators",
      statBrands: "Brands",
      statUnassigned: "No role yet",
      ...
      onboardingPending: "Not finished",
      noInterview: "No interview booked",
      durationValue: "{minutes} min",
      meetReady: "Meet ready",
      meetPreparing: "Meet being prepared",
      meetFailed: "Meet not created",
      meetJoin: "Open Meet",
      meetRetry: "Retry",
      meetRetrying: "Retrying…",
      meetRetryDone: "Meet created",
      meetRetryFailed: "Still failing",
      meetSet: "Meet link attached",
      meetMissing: "No Meet link yet",
      approve: "Approve",
      ...
      status: {
        ...
        pending_interview: "Needs interview",
      ...
      errors: {
        forbidden: "Your admin session has expired. Sign in again.",
        invalid_decision: "That decision is not valid.",
        user_not_found: "That account no longer exists.",
        unconfigured: "The database is unavailable right now.",
        storage_error: "The decision could not be saved. Try again.",
    ...
    sandbox: {
      pageTitle: "Sandbox Audit",
      intro: "Pre-migration checklist. Identify sandbox data before switching WHOP_ENV to production. Do not delete any rows until a backup exists.",
      currentEnvLabel: "Current WHOP_ENV",
      rowCountsTitle: "Row counts by environment",
      tableCol: "Table",
      sandboxCol: "Sandbox",
      productionCol: "Production",
      constraintGapsTitle: "Unique-constraint gaps (no environment column)",
      constraintGapsBody: "These tables have unique indexes that do not include the environment column. Before switching to production, verify that no sandbox provider ID (pay_, rf_, dspt_, dspa_, case_) matches a production one. A collision on migration would cause an insert failure.",
      constraintGapsList: "payment_orders · creator_earnings · payment_refunds · payment_disputes · dispute_alerts · resolution_center_cases · accounting_transactions (idempotency_key) · creator_transfers (idempotency_key)",
      staleRateLimitsTitle: "Stale rate-limit counters",
      staleRateLimitsBody: "Rate-limit rows accumulate one row per hourly window per key. Rows older than 24 hours are harmless but waste space.",
      staleRateLimitsPurge: "Purge command: DELETE FROM rate_limit_counters WHERE CAST(window_key AS BIGINT) < {key}",
      staleCount: "{count} stale rows",
      envFlagsTitle: "Environment flags",
      sandboxUiFlag: "ENABLE_SANDBOX_CHECKOUT_TEST_UI",
      sandboxUiFlagNote: "Must not be 'true' in production. WHOP_ENV = production disables the route regardless, but the flag should be absent.",
      dbUnavailable: "Database unavailable — counts could not be fetched.",
    },
    finance: {
      pageTitle: "Finance",
      ledgerHealth: "Ledger health",
      trialBalance: "Trial balance",
      trialBalanceHint: "Sum of all journal entries by account. Grand total must be zero for a balanced double-entry ledger.",
      balanced: "Balanced",
      unbalanced: "Unbalanced — grand total is not zero",
      grandTotal: "Grand total",
      entryCount: "Entries",
      accountCol: "Account",
      totalMinorCol: "Net minor units",
      kindCol: "Kind",
      normalBalanceCol: "Normal balance",
      reconciliation: "Reconciliation",
      reconciliationHint: "Local-only checks. No provider API calls.",
      paymentsChecked: "Payments checked",
      refundsChecked: "Refunds checked",
      disputesChecked: "Disputes checked",
      settlementsScanned: "Settlements scanned",
      feeDriftCount: "Fee drift",
      feeDriftHint: "Payments posted with estimated fees that have not been reconciled against the provider yet.",
      ...
      disputeIdCol: "Dispute ID",
      transactionIdCol: "Transaction ID",
      orderIdCol: "Order ID",
      paymentDiscrepancies: "Payment discrepancies",
      refundDiscrepancies: "Refund discrepancies",
      disputeDiscrepancies: "Dispute discrepancies",
      feeDriftCandidates: "Fee drift candidates",
      currencyCol: "Currency",
      grossMinorCol: "Gross minor units",
      providerChecks: "Provider checks",
      providerChecksHint: "These checks hit the Whop API. Use sparingly — they are not cached.",
      payoutsCheckLabel: "Payout reconciliation",
      payoutsCheckBody: "Compares the last 100 Whop payouts against our payout_sent ledger entries.",
      balancesCheckLabel: "Full trial balance",
      balancesCheckBody: "Standalone ledger arithmetic check with no provider calls.",
      repairRefundsLabel: "Repair refund postings",
      repairRefundsBody: "Re-posts journal entries for completed refunds with no accounting transaction. Defaults to dry run.",
      repairDisputesLabel: "Repair dispute postings",
      repairDisputesBody: "Re-posts missing dispute ledger movements from the provider's activity feed. Defaults to dry run.",
      apiEndpoint: "API endpoint",
      multiCurrencyNote: "Minor-unit totals span all currencies — they are not summed into a single figure. The zero-sum invariant holds regardless of currency because every transaction balances.",
    },
  },
